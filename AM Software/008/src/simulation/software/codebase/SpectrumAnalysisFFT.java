...
public class SpectrumAnalysisFFT extends JFrame {
    ...
    public SpectrumAnalysisFFT(AMSignal signal, String variant) {
        ...
        spectrumLabel.setFont(new Font("Bahnschrift", Font.BOLD, 12));
        ...
        zoomInButton.setFont(new Font("Bahnschrift", Font.BOLD, 13));
        ...
        zoomOutButton.setFont(new Font("Bahnschrift", Font.BOLD, 13));
        ...
        pauseResumeButton.setFont(new Font("Bahnschrift", Font.BOLD, 13));
